...
from jellybaby.managers import ItemManager
from tagging.fields import TagField

class Item(models.Model):
    """
    A generic jellybaby item. Slightly denormalized for performance.
    """
...
class Bookmark(models.Model):
    ...
    thumbnail     = models.ImageField(upload_to="img/jellybaby/bookmarks/%Y/%m", blank=True)
