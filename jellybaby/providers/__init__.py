...
log = logging.getLogger("jellybaby.update")
...
def active_providers():
    ...
    """
    providers = {}
    for provider in settings.JELLYBABY_PROVIDERS:
...
def expand_star(mod_name):
    """
    Expand something like 'jellybaby.providers.*' into a list of all the modules
    there.
    """
    expanded = []
